...
public class Steps {
	...
	@When("^moves to check out from mini cart$")
	public void moves_to_check_out_from_mini_cart() throws Throwable {
	...
	@When("^enter personal detail on check out page$")
	public void enter_personal_detail_on_check_out_page() throws Throwable {
		Thread.sleep(5000);
